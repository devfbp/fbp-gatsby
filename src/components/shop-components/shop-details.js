				...
				<div className="row">
					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
						...
						<ul>
							...
							<li className="ltn__blog-category">
							<a className="bg-orange" href="#">For Rent</a>
							</li>
					...
					<aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
						...
						<ul>
							...
							<div className="top-rated-product-item clearfix">
								...
								<h6><a href="/shop">Luxury House In Greenville </a></h6>
								<div className="product-price">
									<span>$30,000.00</span>
									<del>$35,000.00</del>
								</div>
							...
							<div className="top-rated-product-item clearfix">
								...
								<h6><a href="/shop">Apartment with Subunits</a></h6>
								<div className="product-price">
									<span>$30,000.00</span>
									<del>$35,000.00</del>
								</div>
							...
							<div className="top-rated-product-item clearfix">
								...
								<h6><a href="/shop">3 Rooms Manhattan</a></h6>
								<div className="product-price">
									<span>$30,000.00</span>
									<del>$35,000.00</del>
								</div>
						...
						<div className="row ltn__popular-product-widget-active slick-arrow-1">
							...
							<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
								...
								<a href="/shop"><img src={PublicUrl+"assets/img/product-3/6.jpg"} alt="#" /></a>
								<div className="real-estate-agent">
									<div className="agent-img">
									<a href="/team-details"><img src={PublicUrl+"assets/img/blog/author.jpg"} alt="#" /></a>
									</div>
