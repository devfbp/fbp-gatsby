					...
					<div className="shoping-cart-inner">
						...
						<table className="table">
							...
							<tr>
								...
								<h4><a href="/product-details">Brake Conversion Kit</a></h4>
								</td>
							...
							<tr>
								...
								<td className="cart-product-info">
								<h4><a href="/product-details">OE Replica Wheels</a></h4>
								</td>
							...
							<tr>
								...
								<td className="cart-product-info">
								<h4><a href="/product-details">Wheel Bearing Retainer</a></h4>
								</td>
						...
						<div className="btn-wrapper text-right go-top">
							<a href="/checkout" className="theme-btn-1 btn btn-effect-1">Proceed to checkout</a>
						</div>
						</div>
					</div>
					</div>
