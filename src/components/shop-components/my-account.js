						  ...
						  <div className="ltn__my-properties-table table-responsive">
							<table className="table">
							  ...
							  <tbody>
								<tr>
								  ...
								  <td>
									<div className="ltn__my-properties-info">
									  <h6 className="mb-10 go-top"><a href="/product-details">New Apartment Nice View</a></h6>
								  ...
								  <td>Feb 22, 2022</td>
								  <td><a href="#">Edit</a></td>
								  <td><Link tp="#"><i className="fa-solid fa-trash-can" /></a></td>
								</tr>
								<tr>
								  <td className="ltn__my-properties-img go-top">
								...
								<tr>
								  <td className="ltn__my-properties-img go-top">
									<a href="/product-details"><img src={PublicUrl+"assets/img/product-3/7.jpg"} alt="#" /></a>
								  </td>
								  <td>
									<div className="ltn__my-properties-info">
									  <h6 className="mb-10 go-top"><a href="/product-details">New Apartment Nice View</a></h6>
