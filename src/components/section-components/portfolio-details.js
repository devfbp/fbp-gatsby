    ...
    return <div className="ltn__page-details-area ltn__portfolio-details-area mb-105">
                ...
                <div className="row">
                    ...
                    <aside className="sidebar-area ltn__right-sidebar">
                        ...
                        <ul className="go-top">
                            <li><a href="/portfolio">Property Management <span><i className="fas fa-arrow-right" /></span></a></li>
                            <li className="active"><a href="/portfolio">Mortgage Service <span><i className="fas fa-arrow-right" /></span></a></li>
                            <li><a href="/portfolio">Consulting Service <span><i className="fas fa-arrow-right" /></span></a></li>
                            <li><a href="/portfolio">Home Buying <span><i className="fas fa-arrow-right" /></span></a></li>
                            <li><a href="/portfolio">Home Selling <span><i className="fas fa-arrow-right" /></span></a></li>
                            <li><a href="/portfolio">Escrow Services <span><i className="fas fa-arrow-right" /></span></a></li>
                        </ul>
                        </div>
                        {/* Newsletter Widget */}
                        ...
                        <a href="/shop"><img src={PublicUrl+"assets/img/banner/banner-2.jpg"} alt="Banner Image" /></a>
                        </div>
                    </aside>
                    </div>
                </div>
