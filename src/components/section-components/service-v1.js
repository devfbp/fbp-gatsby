    ...
    return <div className="ltn__service-area section-bg-1 pt-115 pb-70 go-top">
				...
				<div className="row  justify-content-center">
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<h3><a href="/service-details">Property Management</a></h3>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><a href="/service-details">Mortgage Service</a></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><a href="/service-details">Consulting Service</a></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><a href="/service-details">Home Buying</a></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><a href="/service-details">Home Selling</a></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><a href="/service-details">Escrow Services</a></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
