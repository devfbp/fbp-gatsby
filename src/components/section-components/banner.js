				              ...
				              <div className="slide-item-info">
				                <div className="slide-item-info-inner ltn__slide-animation">
				                  ...
				                  <div className="btn-wrapper animated ">
				                    	<a href="/about" className="theme-btn-1 btn btn-effect-1 go-top">Make An Enquiry</a>
				            ...
				            <div className="col-lg-12 align-self-center">
				              <div className="slide-item-info">
				                <div className="slide-item-info-inner ltn__slide-animation">
				                  ...
				                  <div className="btn-wrapper animated">
				                    <a href="/service" className="theme-btn-1 btn btn-effect-1">OUR SERVICES</a>
				                    <a href="/about" className="btn btn-transparent btn-effect-3">LEARN MORE</a>
				                  </div>
				                </div>
				              </div>
