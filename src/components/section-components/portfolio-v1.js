				...
				<div className="container">
					...
					<div className="ltn__gallery-active row ltn__gallery-style-2 ltn__gallery-info-hide---">
						...
						<div className="ltn__gallery-item-inner">
							...
							<h4 className="go-top"><a href="/portfolio-details">Portfolio Link </a></h4>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><a href="/portfolio-details">Inline Description </a></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><a href="/portfolio-details">Youtube Video </a></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><a href="/portfolio-details">Vimeo Video </a></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><a href="/portfolio-details">HTML5 Video </a></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><a href="/portfolio-details">Google Map </a></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><a href="/portfolio-details">Image Caption </a></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><a href="/portfolio-details">Not Found</a></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
