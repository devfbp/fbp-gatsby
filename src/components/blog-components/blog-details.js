				...
				<div className="ltn__blog-details-wrap">
					...
					<div className="ltn__blog-meta">
						...
						<li className="ltn__blog-author go-top">
							<a href="/team-details"><img src={PublicUrl+"assets/img/blog/author.jpg"} alt="#" />By: Ethan</a>
						</li>
					...
					<div className="row">
						...
						<div className="ltn__blog-item ltn__blog-item-6">
							...
							<a href="/blog-details"><img src={PublicUrl+"assets/img/blog/blog-details/11.jpg"} alt="Image" /></a>
							</div>
							...
							<h3 className="ltn__blog-title"><a href="/blog-details">A series of iOS 7 inspire
						...
						<div className="ltn__blog-item ltn__blog-item-6">
							<div className="ltn__blog-img">
							<a href="/blog-details"><img src={PublicUrl+"assets/img/blog/blog-details/12.jpg"} alt="Image" /></a>
							</div>
							<div className="ltn__blog-brief">
							<div className="ltn__blog-meta">
								<ul>
